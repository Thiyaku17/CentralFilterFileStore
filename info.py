...
API_ID = int(environ['API_ID'], '1305232')
API_HASH = environ['API_HASH', '71b917e302a36826c54988990dc7a789']
BOT_TOKEN = environ['BOT_TOKEN', '2107710484:AAHFQgzcOlFWovDZ3gu5fO0zCNqhbyLxBcU']
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001567219509').split()]
...
auth_grp = environ.get('AUTH_GROUP', '-1001659085034')
